...
const VerifyCertificate = () => {
  ...
  const parish = searchParams.get("parish") || "Nguyễn Văn A";
  const diocese = searchParams.get("diocese") || "Nguyễn Văn A";
  const pastor_name = searchParams.get("pastor_name") || "Nguyễn Văn A";
  ...
  const getCertTypeName = (type) => {
    switch (type) {
      case "catechism_course":
        return "Chứng Chỉ Giáo Lý";

      case "school_year":
        return "Chứng Nhận Hoàn Thành Năm Học";

      case "catechism_exam":
        return "Chứng Nhận Kỳ Thi Giáo Lý";

      case "final_exam":
        return "Chứng Nhận Hoàn Thành Khóa Giáo Lý";
      ...
      case "marriage":
        return "Chứng Chỉ Giáo Lý Hôn Nhân";

      case "catechumen":
        return "Chứng Nhận Hoàn Thành Giáo Lý Dự Tòng";

      case "initiation":
        return "Chứng Nhận Hoàn Thành Giáo Lý Khai Tâm";

      case "achievement":
        return "Chứng Nhận Thành Tích Giáo Lý";

      default:
        return "Chứng Nhận Giáo Lý";
    }
  };
            ...
            {loading ? (
              ...
              <div>
                ...
                >
                  ...
                  >
                    <span>
                      Giáo xứ {parish} — Giáo phận {diocese}
                    </span>
                  </Descriptions.Item>
